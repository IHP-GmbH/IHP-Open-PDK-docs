...
be used to create manufacturable designs at IHP's facility. In addition, the goal of this [IHP-Open-PDK-docs](<https://github.com/IHP-GmbH/IHP-Open-PDK-docs/>)
...
**Warning:** This documentation is *work in progress*. The content is currently provided as: *Experimental Preview*
